        ...
        <div className="flex items-center justify-between">
          ...
          >
            <ul className="flex items-center flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <Link to="/#services" className="block py-2 pr-4 pl-3 text-white text-xl font-bold bg-blue-700 rounded md:bg-transparent  md:p-0 dark:text-white "
                  aria-current="page">
                  Services
                </Link>
              ...
              <li>
                <Link to="/#solutions"
                  className="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent text-xl md:border-0  md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 font-bold"
                >
                  Solutions
                </Link>
              </li>
              <li>
                <Link to={"/careers"}
                  className="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent text-xl font-bold md:border-0  md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Careers
                </Link>
              </li>
              ...
              <Link to={"/contactus"}>
                <button className="px-7 py-2 bg-white rounded-md text-xl text-black font-bold">Contact Us</button>
              </Link>
